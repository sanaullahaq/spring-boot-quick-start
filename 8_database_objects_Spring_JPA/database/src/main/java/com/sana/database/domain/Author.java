...
//Example: If you have a class Author, and it's annotated with @Entity, Hibernate will know it should create or manage a table for it.

//@Table(name = "authors")
//Purpose: Specifies the name of the table in the database that this entity maps to.
//Why it's useful: If your entity is named Author but your database table is authors, this annotation handles that mismatch.
//Without it: The table name would default to the class name (Author) by default.
